...
class DetailVDESeite(DetailBasis):
    ...
    def _erstelle_ui(self):
        ...
        # Fixierter Bereich oben (Header + Stepper)
        fix_oben = QWidget()
        ...
        self._content = fix_layout  # temporaer fuer Header/Stepper

        self._erstelle_header()
        self._erstelle_stepper()

        # Infoboxen (fixiert, wechseln mit Seite)
        ...
        # Scrollbereich (nur Wizard-Seiten)
        scroll = QScrollArea()
    ...
    def _erstelle_stepper(self):
        ...
        self._stepper_widget.setFixedHeight(40)
    ...
    def setze_waage(self, waage_daten, farben, kundennummer=None):
        ...
        # PDF-Status pruefen
        pdf_pfad = self._finde_existierendes_pdf(wj_nummer, prefix="VDE")
        if pdf_pfad:
    ...
    def aktualisiere_theme(self, farben):
        ...
        if self._pdf_feedback.isVisible():
            pdf_pfad = self._finde_existierendes_pdf(self._wj_nummer(), prefix="VDE")
            if pdf_pfad:
                self._zeige_pdf_feedback(pdf_pfad)
    ...
    def _erstelle_pdf(self):
        ...
        existierendes_pdf = self._finde_existierendes_pdf(wj_nummer, prefix="VDE")
